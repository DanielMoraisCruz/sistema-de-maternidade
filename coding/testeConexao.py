...
conexao = mysql.connector.connect(  # funcao que realiza a conexão
    ...
    host='localhost',  # passar o host, se o BD estiver no seu
                       # computador use local Host
...
nome = "lucas"
comando = f'''INSERT INTO medico (CRM,Especialidade,Nome)
              VALUES ("{crm}", "{especialidade}","{nome}")'''
